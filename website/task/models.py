...
class Task(models.Model):
  ...
  s_latitude = models.DecimalField(max_digits=10, decimal_places=6, blank=True)
  s_longitude = models.DecimalField(max_digits=10, decimal_places=6, blank=True)
  d_latitude = models.DecimalField(max_digits=10, decimal_places=6, blank=True)
  d_longitude = models.DecimalField(max_digits=10, decimal_places=6, blank=True)
